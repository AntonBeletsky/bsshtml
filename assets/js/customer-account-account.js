...
class PersonalInfoManager {
  constructor(formId) {
    ...
    if (this.editButton && this.saveButton) {
...
// Create a MutationObserver to watch for changes in the attributes of <body>
const observer = new MutationObserver(() => {
  // Use setTimeout to ensure the style removal happens after Bootstrap applies it
  setTimeout(() => {
    // Remove the "style" attribute from <body> to prevent unwanted padding
